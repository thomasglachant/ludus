...
const skillEffectPatternsByBuilding = {
  ...
  canteen: [
    ...
    { type: 'increaseHealth', target: 'plannedGladiators', values: [1, 1.5, 2, 2.5] },
    { type: 'increaseIncome', target: 'ludus', values: [0.5, 1, 1.5, 2] },
    { type: 'increaseProduction', target: 'ludus', values: [0.5, 1, 1.5, 2] },
    { type: 'increaseMorale', target: 'plannedGladiators', values: [1, 1.5, 2, 2.5] },
  ],
  dormitory: [
    { type: 'increaseEnergy', target: 'plannedGladiators', values: [1, 1.5, 2, 2.5] },
    { type: 'increaseMorale', target: 'plannedGladiators', values: [1, 1.5, 2, 2.5] },
    { type: 'decreaseRebellion', target: 'ludus', values: [1, 1.5, 2, 2.5] },
    { type: 'increaseHealth', target: 'plannedGladiators', values: [0.5, 1, 1.5, 2] },
