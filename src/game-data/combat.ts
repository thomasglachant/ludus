...
export const COMBAT_CONFIG = {
  ...
  baseHealth: GAME_BALANCE.combat.baseHealth,
  lifeHealthMultiplier: GAME_BALANCE.combat.lifeHealthMultiplier,
  baseEnergy: GAME_BALANCE.combat.baseEnergy,
  strengthEnergyMultiplier: GAME_BALANCE.combat.strengthEnergyMultiplier,
  agilityEnergyMultiplier: GAME_BALANCE.combat.agilityEnergyMultiplier,
  lifeEnergyMultiplier: GAME_BALANCE.combat.lifeEnergyMultiplier,
  baseMorale: GAME_BALANCE.combat.baseMorale,
