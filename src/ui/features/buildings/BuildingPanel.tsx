...
import { getLedgerEntryAmount } from '@/ui/shared/formatters/ledger';
import { GameInlineHint, GameNotice } from '@/ui/shared/ludus/GameFeedback';
import { GameBadge, GameEffectList, GameSection, GameStats } from '@/ui/shared/ludus/GameSection';
import { GameIcon } from '@/ui/shared/icons/GameIcon';
import { GladiatorListRow } from '@/ui/features/gladiators/GladiatorListRow';
import { BuildingActionModalContent } from '@/ui/features/buildings/BuildingActionModalContent';
import {
  ModalActionDock,
  ModalContentFrame,
  ModalHeroCard,
    ...
    <ModalContentFrame>
      ...
      >
        <ModalTabPanel tabId="overview">
          <GameSection titleKey="buildings.currentEffects">
            <GameEffectList
              effects={viewModel.effects}
              emptyMessageKey="buildings.noActiveEffects"
            />
          </GameSection>
          {ludusCapacity ? (
            <GameSection titleKey="ludusCapacity.title">
              <GameStats
                items={[
                  {
        ...
        {onOpenGladiator ? (
          <ModalTabPanel tabId="gladiators">
        ...
        {hasConfiguration ? (
          <ModalTabPanel tabId="configuration">
                ...
                <div className="context-panel__list">
                  {viewModel.policies.map((policy) => (
                    ...
                    >
                      ...
                      />
                      <GameEffectList effects={policy.effects} />
                      {policy.validationMessageKey ? (
                        <GameNotice tone={policy.isSelected ? 'info' : 'warning'}>
                ...
                <div className="context-panel__list">
                  {viewModel.activities.map((activity) => (
                    ...
                    >
                      ...
                      />
                      <GameNotice tone={activity.isUnlocked ? 'info' : 'warning'}>
                        {t(
                          activity.isUnlocked
                ...
                <div className="context-panel__list">
                  {viewModel.improvements.map((improvement) => (
                    ...
                    >
                      ...
                      />
                      <GameEffectList effects={improvement.effects} />
                      {improvement.validationMessageKey ? (
                        <GameNotice tone={improvement.isPurchased ? 'info' : 'warning'}>
            ...
            {viewModel.skills.length > 0 ? (
              <ModalSection titleKey="buildingPanel.tabs.skills">
                <div className="building-skill-tree">
                  <GameSection className="building-skill-tree__summary">
                    <GameStats
                      columns={3}
                      items={[
                        {
                      ...
                      >
                        ...
                        <div className="building-skill-tree__nodes">
                          {skills.map((skill) => {
                            ...
                            const requiredLevelIsMet =
                              viewModel.level >= skill.requiredBuildingLevel;
                                ...
                                <div className="building-skill-tree__details">
                                  ...
                                  <div className="building-skill-tree__detail-block">
                                    ...
                                    {skill.unlockedActivities.length > 0 ? (
                                      ...
                                      <GameInlineHint
                                        className="building-skill-tree__empty"
                                        messageKey="buildingPanel.skillNoUnlockedActivities"
                                        surface="plain"
                                      />
                                    )}
                                  </div>
                                </div>
                                <GameEffectList effects={skill.effects} />
                                {skill.validationMessageKey ? (
                                  <GameNotice tone={skill.isPurchased ? 'info' : 'warning'}>
