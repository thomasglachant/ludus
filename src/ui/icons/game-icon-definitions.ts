...
export const GAME_ICON_DEFINITIONS = {
  ...
  contracts: { Icon: RiFileList3Fill, color: '#d6a34a' },
  defense: { Icon: RiShieldFill, color: '#7b86a0' },
